-- =====================================================
-- VIP ENGLISH LEARNING - PERFECT UTF-8 DATABASE
-- =====================================================
-- File: vip_utf8_perfect.sql
-- Description: Perfect UTF-8 encoding database with all data
-- =====================================================
...
-- =====================================================
-- 1. LANGUAGES TABLE - Bảng ngôn ngữ
-- =====================================================
...
-- =====================================================
-- 3. VOCABULARY TABLE - Bảng từ vựng
-- =====================================================
...
-- =====================================================
-- 4. STUDY METHODS TABLE - Bảng phương pháp học
-- =====================================================
...
-- =====================================================
-- 5. INSERT LANGUAGES DATA - Dữ liệu ngôn ngữ
-- =====================================================
...
-- =====================================================
-- 6. INSERT STUDY METHODS DATA - Dữ liệu phương pháp học
-- =====================================================
...
-- =====================================================
-- 7. INSERT TOPICS DATA - Dữ liệu chủ đề
-- =====================================================

-- Vietnamese Topics (LanguageID = 1)
...
-- =====================================================
-- 8. INSERT VOCABULARY DATA - Dữ liệu từ vựng
-- =====================================================

-- Vietnamese Family Vocabulary (TopicID = 1)
...
-- Vietnamese Food Vocabulary (TopicID = 2)
INSERT INTO Vocabulary (WordID, Word, Phonetic, Type, Meaning, Example, Audio, TopicID, LanguageID, Difficulty) VALUES
...
-- Vietnamese Travel Vocabulary (TopicID = 10)
INSERT INTO Vocabulary (WordID, Word, Phonetic, Type, Meaning, Example, Audio, TopicID, LanguageID, Difficulty) VALUES
...
-- English Family Vocabulary (TopicID = 11)
INSERT INTO Vocabulary (WordID, Word, Phonetic, Type, Meaning, Example, Audio, TopicID, LanguageID, Difficulty) VALUES
...
-- English Food Vocabulary (TopicID = 12)
INSERT INTO Vocabulary (WordID, Word, Phonetic, Type, Meaning, Example, Audio, TopicID, LanguageID, Difficulty) VALUES
...
-- English Travel Vocabulary (TopicID = 20)
INSERT INTO Vocabulary (WordID, Word, Phonetic, Type, Meaning, Example, Audio, TopicID, LanguageID, Difficulty) VALUES
...
-- Chinese Family Vocabulary (TopicID = 21)
INSERT INTO Vocabulary (WordID, Word, Phonetic, Type, Meaning, Example, Audio, TopicID, LanguageID, Difficulty) VALUES
...
-- Korean Family Vocabulary (TopicID = 31)
INSERT INTO Vocabulary (WordID, Word, Phonetic, Type, Meaning, Example, Audio, TopicID, LanguageID, Difficulty) VALUES
...
-- Japanese Family Vocabulary (TopicID = 41)
INSERT INTO Vocabulary (WordID, Word, Phonetic, Type, Meaning, Example, Audio, TopicID, LanguageID, Difficulty) VALUES
...
-- Thai Family Vocabulary (TopicID = 51)
INSERT INTO Vocabulary (WordID, Word, Phonetic, Type, Meaning, Example, Audio, TopicID, LanguageID, Difficulty) VALUES
...
-- =====================================================
-- 9. UPDATE VOCABULARY COUNT - Cập nhật số lượng từ vựng
-- =====================================================
...
-- ✅ Perfect UTF-8 database created!
-- ✅ All tables use utf8mb4_unicode_ci collation
-- ✅ Multi-language support: Vietnamese, English, Chinese, Korean, Japanese, Thai
-- ✅ 60 topics across 6 languages
-- ✅ 60 vocabulary words with perfect encoding
-- ✅ 3 study methods included
-- ✅ Ready for perfect frontend display! 🎉
